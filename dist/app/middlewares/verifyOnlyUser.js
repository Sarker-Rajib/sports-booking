...
exports.verifyOnlyUser = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (role !== "user") {
        throw new ErrorHandlers_1.AppError(400, "You have no access to this route");
    }
    next();
}));
